define(['ninejs/ui/utils/setText',
	...
	"../css/extensions/Pagination.ncss", "dojo/_base/sniff"],
function(setText, setClass, append, extend, _StoreMixin, declare, arrayUtil, lang, Deferred, on, query, string, has, i18n, css){
	css.enable();
